...
> 对比更新日期：2026-09-16
>
> 依据：2026-09-16 快照的各单项目调查笔记（Agent 工具、Agent 角色、会话与消息管理、对话请求与上下文、Chat UI、LLM 渠道管理、仓库分布、消息渲染器等类目）及横向对比；RikkaHub 按同一 0-5 分量表补入逐项目评分，分项依据其仓库分布、会话与消息管理、消息渲染器、LLM 渠道管理、Agent 角色、Agent 工具、外部执行体与应用协作、检索增强与认知编排及上下文编译与提示词工程来源笔记，证据均为静态源码
>
