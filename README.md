...
| VCPToolBox | [✅](已调查能力汇总/VCPToolBox-已调查能力汇总.md) | [✅](仓库分布/VCPToolBox-仓库分布调查笔记.md) | [✅](产品结构与设计基因/VCPToolBox-产品结构与设计基因调查笔记.md) | [✅](会话与消息管理/VCPToolBox-会话与消息管理调查笔记.md) | [✅](对话请求与上下文/VCPToolBox-对话请求与上下文调查笔记.md) | [N/A](Chat UI/VCPToolBox-ChatUI调查笔记.md) | N/A | N/A | [✅](LLM渠道管理/VCPToolBox-LLM渠道管理调查笔记.md) | [✅](Agent角色/VCPToolBox-Agent角色配置调查笔记.md) | [✅](Agent工具/VCPToolBox-Agent工具调查笔记.md) | [✅](外部执行体与应用协作/VCPToolBox-外部执行体与应用协作调查笔记.md) | [✅](检索增强与认知编排/VCPToolBox-检索增强与认知编排调查笔记.md) | [✅](生成式输出与运行时/VCPToolBox-生成式输出与运行时调查笔记.md) | [✅](媒体创作/VCPToolBox-媒体创作调查笔记.md) | [✅](应用界面基础设施/VCPToolBox-应用界面基础设施调查笔记.md) | [✅](独特功能/VCPToolBox-独特功能调查笔记.md) |
