...
<details>
<summary><b>已收录项目清单（共 24 个）</b></summary>
...
- [Codex](仓库分布/Codex-仓库分布调查笔记.md) — https://github.com/openai/codex
...
- [OpenClaw](已调查能力汇总/OpenClaw-已调查能力汇总.md) — https://github.com/openclaw/openclaw
...
| OpenClaw | [✅](已调查能力汇总/OpenClaw-已调查能力汇总.md) | [✅](仓库分布/OpenClaw-仓库分布调查笔记.md) | — | [✅](会话与消息管理/OpenClaw-会话与消息管理调查笔记.md) | [✅](对话请求与上下文/OpenClaw-对话请求与上下文调查笔记.md) | [✅](Chat%20UI/OpenClaw-ChatUI调查笔记.md) | [✅](消息渲染器/OpenClaw-消息渲染器调查笔记.md) | [✅](对话导出与分享/OpenClaw-对话导出与分享调查笔记.md) | [✅](LLM渠道管理/OpenClaw-LLM渠道管理调查笔记.md) | [✅](Agent角色/OpenClaw-Agent角色配置调查笔记.md) | [✅](Agent工具/OpenClaw-Agent工具调查笔记.md) | [✅](外部执行体与应用协作/OpenClaw-外部执行体与应用协作调查笔记.md) | [✅](检索增强与认知编排/OpenClaw-检索增强与认知编排调查笔记.md) | [✅](生成式输出与运行时/OpenClaw-生成式输出与运行时调查笔记.md) | [✅](媒体创作/OpenClaw-媒体创作调查笔记.md) | [✅](应用界面基础设施/OpenClaw-应用界面基础设施调查笔记.md) | [✅](独特功能/OpenClaw-独特功能调查笔记.md) |
...
| VCPToolBox | [✅](已调查能力汇总/VCPToolBox-已调查能力汇总.md) | [✅](仓库分布/VCPToolBox-仓库分布调查笔记.md) | [✅](产品结构与设计基因/VCPToolBox-产品结构与设计基因调查笔记.md) | [✅](会话与消息管理/VCPToolBox-会话与消息管理调查笔记.md) | [✅](对话请求与上下文/VCPToolBox-对话请求与上下文调查笔记.md) | [N/A](Chat%20UI/VCPToolBox-ChatUI调查笔记.md) | N/A | N/A | [✅](LLM渠道管理/VCPToolBox-LLM渠道管理调查笔记.md) | [✅](Agent角色/VCPToolBox-Agent角色配置调查笔记.md) | [✅](Agent工具/VCPToolBox-Agent工具调查笔记.md) | [✅](外部执行体与应用协作/VCPToolBox-外部执行体与应用协作调查笔记.md) | [✅](检索增强与认知编排/VCPToolBox-检索增强与认知编排调查笔记.md) | [✅](生成式输出与运行时/VCPToolBox-生成式输出与运行时调查笔记.md) | [✅](媒体创作/VCPToolBox-媒体创作调查笔记.md) | [✅](应用界面基础设施/VCPToolBox-应用界面基础设施调查笔记.md) | [✅](独特功能/VCPToolBox-独特功能调查笔记.md) |
...
| [上下文编译与提示词工程](上下文编译与提示词工程/) | 可编辑规则、模板、宏和占位符如何按作用域与顺序编译到请求、消息或显示投影 |
